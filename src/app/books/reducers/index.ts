...
import * as fromSearch from '@app/books/reducers/search.reducer';
import * as fromBooks from '@app/books/reducers/books.reducer';
import * as fromCollection from '@app/books/reducers/collection.reducer';
