...
export const selectSettings = createSelector(
  selectLayoutState,
  fromLayout.selectSettings
);

export const selectUserRegistrationFields = createSelector(
  selectLayoutState,
  fromLayout.selectUserRegistrationFields
);
export const selectCountries = createSelector(
  selectLayoutState,
  fromLayout.selectCountries
);
export const selectLanguages = createSelector(
  selectLayoutState,
  fromLayout.selectLanguages
);
export const selectRoles = createSelector(
  selectLayoutState,
  fromLayout.selectRoles
);
