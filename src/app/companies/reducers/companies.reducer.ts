...
export const reducer = createReducer(
   ...
   */
  on(
    CompaniesApiActions.searchSuccess,
    CollectionApiActions.loadCompaniesSuccess,
    (state, { companies }) => adapter.addMany(companies, state)
  ),
  /**
   ...
   */
  on(CompanyActions.loadCompany, (state, { company }) => adapter.addOne(company, state)),
  on(ViewCompanyPageActions.selectCompany, (state, { id }) => ({
    ...state,
